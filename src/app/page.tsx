...
export default function Home() {
  ...
  return (
    <div className="bg-slate-50">
      ...
      <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
        ...
        flex flex-col items-center lg:items-start">
          <div className="absolute w-20 left-0 -top-20 hidden lg:block">
            <img src="./snake-1.png" className="w-full" alt="Serpiente feliz" />
          </div>
          ...
          Tu imagen en una <span className="bg-green-600 px-2 text-white">funda</span> de teléfono personalizada
          </h1>
          <p className="mt-8 text-lg lg:pr-10 max-w-prose text-center lg:text-left
          text-balance md:text-wrap ">Captura tus recuerdos favoritos con tu propia, {''} 
          <span className="font-semibold">tu propia funda </span>
          casecobra te permite proteger tus recuerdos, no solo la funda de tu teléfono
          </p>
          <ul className="mt-8 space-y-8 text-left font-medium flex
          ...
          sm:items-start gap-5">
            <div className="flex -space-x-4">
              <img className="inline-block h-10 object-cover w-10 rounded-full ring-2
              ring-slate-100"
              src="./user/user-1.png" 
            ...
            items-center sm:items-start">
              ...
              <p>
                <span className="font-semibold">1.250</span> clientes felices
              </p>
            </div>
          </div>
        </div>
      ...
      px-8 sm:px-0 mt-12 lg:mx-0 lg:mt-20 h-fit">
